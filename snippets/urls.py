...
router.register(r'aoresponsetoppositivenegativereport', views.AOResponseTopPositiveNegativeViewSet)
...
urlpatterns += format_suffix_patterns([
    ...
    url(r'checkdashboardstatus', views.CheckDashboardSatusView.as_view())
])
