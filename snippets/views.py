...
class AdvisorInsightsView(APIView):
    ...
    def get(self, format=None):
        ...
        amresponsereportqueryset = AMResponse.objects.all().filter(
            survey__id=survey, subProjectUser__id=projectUser).order_by('integerValue')
        amresponsereportserializer = AMResponseForDriverAnalysisSerializer(
            amresponsereportqueryset, many=True)
        amresponsereportdata = amresponsereportserializer.data

        aoresponsereportqueryset = AOResponse.objects.all().filter(
            survey__id=survey, subProjectUser__id=projectUser).order_by('integerValue')
        ...
        for i in range(len(amresponsereportdata)):
            ...
            aryTeamsData[amresponsereportdata[i]['projectUser']["team"]["name"]] = {
                "totalScore": 0, "cnt": 0, "score": 0, "compTotalScore": 0, "compCnt": 0, "compScore": 0}
            if (amresponsereportdata[i]['projectUser']['shGroup'] is not None):
                aryShGroupsData[amresponsereportdata[i]
                                ['projectUser']['shGroup']['SHGroupName']] = {"totalScore": 0, "cnt": 0, "score": 0, "compTotalScore": 0, "compCnt": 0, "compScore": 0}
            if (amresponsereportdata[i]['projectUser']['user']['organization'] is not None):
        ...
        for i in range(len(amresponsereportdata)):
            ...
            if (amresponsereportdata[i]['projectUser']['shGroup'] is not None):
                aryShGroupsData[amresponsereportdata[i]['projectUser']['shGroup']
                                ['SHGroupName']]['totalScore'] += amresponsereportdata[i]["integerValue"]
                aryShGroupsData[amresponsereportdata[i]['projectUser']
                                ['shGroup']['SHGroupName']]['cnt'] += 1
                aryShGroupsData[amresponsereportdata[i]['projectUser']['shGroup']['SHGroupName']]['score'] = round(
                    aryShGroupsData[amresponsereportdata[i]['projectUser']['shGroup']['SHGroupName']]['totalScore'] / 10 / aryShGroupsData[amresponsereportdata[i]['projectUser']['shGroup']['SHGroupName']]['cnt'], 2)

                if (amresponsereportdata[i]["controlType"] == "TEXT") | (amresponsereportdata[i]["controlType"] == "MULTI_TOPICS"):
                    aryShGroupsData[amresponsereportdata[i]['projectUser']['shGroup']
                                    ['SHGroupName']]['compTotalScore'] += amresponsereportdata[i]["integerValue"]
                    aryShGroupsData[amresponsereportdata[i]['projectUser']
                                    ['shGroup']['SHGroupName']]['compCnt'] += 1
                    aryShGroupsData[amresponsereportdata[i]['projectUser']['shGroup']['SHGroupName']]['compScore'] = round(
                        aryShGroupsData[amresponsereportdata[i]['projectUser']['shGroup']['SHGroupName']]['compTotalScore'] / 10 / aryShGroupsData[amresponsereportdata[i]['projectUser']['shGroup']['SHGroupName']]['compCnt'], 2)

            if (amresponsereportdata[i]['projectUser']['user']['organization'] is not None):
                aryOrganizationsData[amresponsereportdata[i]['projectUser']['user']['organization']
                                     ['name']]['totalScore'] += amresponsereportdata[i]["integerValue"]
                aryOrganizationsData[amresponsereportdata[i]['projectUser']
                                     ['user']['organization']['name']]['cnt'] += 1
                aryOrganizationsData[amresponsereportdata[i]['projectUser']['user']['organization']['name']]['score'] = round(
                    aryOrganizationsData[amresponsereportdata[i]['projectUser']['user']['organization']['name']]['totalScore'] / 10 / aryOrganizationsData[amresponsereportdata[i]['projectUser']['user']['organization']['name']]['cnt'], 2)

                if (amresponsereportdata[i]["controlType"] == "TEXT") | (amresponsereportdata[i]["controlType"] == "MULTI_TOPICS"):
                    aryOrganizationsData[amresponsereportdata[i]['projectUser']['user']['organization']
                                         ['name']]['compTotalScore'] += amresponsereportdata[i]["integerValue"]
                    aryOrganizationsData[amresponsereportdata[i]['projectUser']
                                         ['user']['organization']['name']]['compCnt'] += 1
                    aryOrganizationsData[amresponsereportdata[i]['projectUser']['user']['organization']['name']]['compScore'] = round(
                        aryOrganizationsData[amresponsereportdata[i]['projectUser']['user']['organization']['name']]['compTotalScore'] / 10 / aryOrganizationsData[amresponsereportdata[i]['projectUser']['user']['organization']['name']]['compCnt'], 2)

        for j in range(len(aoresponsereportdata)):
            aryTeamsData[aoresponsereportdata[j]['projectUser']["team"]["name"]
                         ]["totalScore"] += aoresponsereportdata[j]["integerValue"]
            aryTeamsData[aoresponsereportdata[j]
                         ['projectUser']["team"]["name"]]["cnt"] += 1
            aryTeamsData[aoresponsereportdata[j]['projectUser']["team"]["name"]]["score"] = round(
                aryTeamsData[aoresponsereportdata[j]['projectUser']["team"]["name"]]["totalScore"] / 10 / aryTeamsData[aoresponsereportdata[j]['projectUser']["team"]["name"]]["cnt"], 2)

            if (aoresponsereportdata[j]["controlType"] == "TEXT") | (aoresponsereportdata[j]["controlType"] == "MULTI_TOPICS"):
                aryTeamsData[aoresponsereportdata[j]['projectUser']["team"]["name"]
                             ]["compTotalScore"] += aoresponsereportdata[j]["integerValue"]
                aryTeamsData[aoresponsereportdata[j]
                             ['projectUser']["team"]["name"]]["compCnt"] += 1
                aryTeamsData[aoresponsereportdata[j]['projectUser']["team"]["name"]]["compScore"] = round(
                    aryTeamsData[aoresponsereportdata[j]['projectUser']["team"]["name"]]["compTotalScore"] / 10 / aryTeamsData[aoresponsereportdata[j]['projectUser']["team"]["name"]]["compCnt"], 2)
            ...
            if (aoresponsereportdata[j]['projectUser']['shGroup'] is not None):
                ...
                if (aoresponsereportdata[j]["controlType"] == "TEXT") | (aoresponsereportdata[j]["controlType"] == "MULTI_TOPICS"):
                    aryShGroupsData[aoresponsereportdata[j]['projectUser']['shGroup']
                                    ['SHGroupName']]['compTotalScore'] += aoresponsereportdata[j]["integerValue"]
                    aryShGroupsData[aoresponsereportdata[j]['projectUser']
                                    ['shGroup']['SHGroupName']]['compCnt'] += 1
                    aryShGroupsData[aoresponsereportdata[j]['projectUser']['shGroup']['SHGroupName']]['compScore'] = round(
                        aryShGroupsData[aoresponsereportdata[j]['projectUser']['shGroup']['SHGroupName']]['compTotalScore'] / 10 / aryShGroupsData[aoresponsereportdata[j]['projectUser']['shGroup']['SHGroupName']]['compCnt'], 2)

            if (aoresponsereportdata[j]['projectUser']['user']['organization'] is not None):
                aryOrganizationsData[aoresponsereportdata[j]['projectUser']['user']['organization']
                                     ['name']]['totalScore'] += aoresponsereportdata[j]["integerValue"]
                aryOrganizationsData[aoresponsereportdata[j]['projectUser']
                                     ['user']['organization']['name']]['cnt'] += 1
                aryOrganizationsData[aoresponsereportdata[j]['projectUser']['user']['organization']['name']]['score'] = round(
                    aryOrganizationsData[aoresponsereportdata[j]['projectUser']['user']['organization']['name']]['totalScore'] / 10 / aryOrganizationsData[aoresponsereportdata[j]['projectUser']['user']['organization']['name']]['cnt'], 2)

                if (aoresponsereportdata[j]["controlType"] == "TEXT") | (aoresponsereportdata[j]["controlType"] == "MULTI_TOPICS"):
                    aryOrganizationsData[aoresponsereportdata[j]['projectUser']['user']['organization']
                                         ['name']]['compTotalScore'] += aoresponsereportdata[j]["integerValue"]
                    aryOrganizationsData[aoresponsereportdata[j]['projectUser']
                                         ['user']['organization']['name']]['compCnt'] += 1
                    aryOrganizationsData[aoresponsereportdata[j]['projectUser']['user']['organization']['name']]['compScore'] = round(
                        aryOrganizationsData[aoresponsereportdata[j]['projectUser']['user']['organization']['name']]['compTotalScore'] / 10 / aryOrganizationsData[aoresponsereportdata[j]['projectUser']['user']['organization']['name']]['compCnt'], 2)

        aryFilteredProjectUsers = aryProjectUsers[:3]
        recommendedProjectUsersQuerySet = ProjectUser.objects.filter(
            survey=survey, pk__in=aryFilteredProjectUsers)
        recommendedProjectUserSerializer = ProjectUserForReportSerializer(
            recommendedProjectUsersQuerySet, many=True)

        # test data for catchup
        aryFilteredCatchupProjectUsers = aryProjectUsers
        recommendedCatchupProjectUsersQuerySet = ProjectUser.objects.filter(
            survey=survey, pk__in=aryFilteredCatchupProjectUsers)
        recommendedCatchupProjectUserSerializer = ProjectUserForReportSerializer(
            recommendedCatchupProjectUsersQuerySet, many=True)

        project = Survey.objects.get(pk=survey).project
        totalTeamMembersCnt = Team.objects.filter(project=project).count()
        totalStakeHoldersCnt = ProjectUser.objects.filter(
            survey=survey).count()
        responseRateFromInvitedTeamMembers = len(
            aryTeams) * 100 / totalTeamMembersCnt
        responseRateFromInvitedStakeholders = len(
            aryProjectUsers) * 100 / totalStakeHoldersCnt
        totalDepartments = len(aryDepartments)
        ...
        positivelyTeamScore = max(
            aryTeamsData[key]['score'] for key in aryTeamsData) if len(aryTeamsData) > 0 else 0
        negativelyTeamScore = min(
            aryTeamsData[key]['score'] for key in aryTeamsData) if len(aryTeamsData) > 0 else 0
        optimisticTeamScore = max(aryTeamsData[key]['compScore']
                                  for key in aryTeamsData) if len(aryTeamsData) > 0 else 0
        pessimisticTeamScore = min(
            aryTeamsData[key]['compScore'] for key in aryTeamsData) if len(aryTeamsData) > 0 else 0
        positivelyTeamName = ""
        negativelyTeamName = ""
        ...
        positivelyShGroupScore = max(
            aryShGroupsData[key]['score'] for key in aryShGroupsData) if len(aryShGroupsData) > 0 else 0
        negativelyShGroupScore = min(
            aryShGroupsData[key]['score'] for key in aryShGroupsData) if len(aryShGroupsData) > 0 else 0
        optimisticShGroupScore = max(
            aryShGroupsData[key]['compScore'] for key in aryShGroupsData) if len(aryShGroupsData) > 0 else 0
        pessimisticShGroupScore = min(
            aryShGroupsData[key]['compScore'] for key in aryShGroupsData) if len(aryShGroupsData) > 0 else 0
        positivelyShGroupName = ""
        negativelyShGroupName = ""
        optimisticShGroupName = ""
        ...
        positivelyOrgScore = max(aryOrganizationsData[key]['score'] for key in aryOrganizationsData) if len(
            aryOrganizationsData) > 0 else 0
        negativelyOrgScore = min(aryOrganizationsData[key]['score'] for key in aryOrganizationsData) if len(
            aryOrganizationsData) > 0 else 0
        optimisticOrgScore = max(aryOrganizationsData[key]['score'] for key in aryOrganizationsData) if len(
            aryOrganizationsData) > 0 else 0
        pessimisticOrgScore = min(aryOrganizationsData[key]['score'] for key in aryOrganizationsData) if len(
            aryOrganizationsData) > 0 else 0
        positivelyOrgName = ""
        negativelyOrgName = ""
        optimisticOrgName = ""
