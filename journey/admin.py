...
class JourneyAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        dataSource = []
        dataSource.append({"id": "2", "x": "90", "y": "480", "name": "1A. Invitation Email", "color": "#FFEEDD", "link": "http://3.12.84.76:3030/email/template2.html", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "3", "x": "190", "y": "480", "name": "Invited Landing Page", "color": "#FFEEDD", "link": "http://3.12.84.76:3031/set-password", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "4", "x": "290", "y": "480", "name": "2A. Confirm Details(Account Created)", "color": "#FFEEDD", "link": "http://3.12.84.76:3031/welcome", "width": "80", "height": "40", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "5", "x": "340", "y": "550", "name": "3A. Login Page", "link": "http://3.12.84.76:3031/login", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "6", "x": "390", "y": "480", "name": "4. Welcome", "link": "http://3.12.84.76:3031/welcome", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "7", "x": "490", "y": "480", "name": "5. About Me Survey", "link": "http://3.12.84.76:3031/app/about-me/start", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "8", "x": "590", "y": "480", "name": "6. My Map", "link": "http://3.12.84.76:3031/app/my-map", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "9", "x": "690", "y": "480", "name": "7. Project Map", "link": "", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "10", "x": "790", "y": "480", "name": "8. Dashboard", "color": "#6B6B6B", "link": "http://3.12.84.76:3031/app/me", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "11", "x": "90", "y": "410", "name": "1B. Organic Search", "link": "", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "12", "x": "210", "y": "410", "name": "2B. Landing Page(Try it)/Capture Details/Sales", "link": "http://3.12.84.76:3030", "width": "100", "height": "50", "shape": "RECTANGLE", "tooltext": ""})
        ...
        dataSource.append({"id": "15", "x": "490", "y": "410", "name": "5A. Survey Navigation", "link": "http://33.12.84.76:3031/app/about-me/start", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "16", "x": "590", "y": "410", "name": "6A. KeyLines 'MyMap'", "color": "#FF4747", "link": "http://3.12.84.76:3031/app/my-map", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        ...
        dataSource.append({"id": "21", "x": "490", "y": "340", "name": "5B. About Me Question Components", "link": "http://3.12.84.76:3031/app/about-me/start", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "22", "x": "590", "y": "340", "name": "6X. Tree Style 'MyMap'", "link": "http://3.12.84.76:3031/app/my-map", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        ...
        dataSource.append({"id": "26", "x": "400", "y": "190", "name": "3A. Login Page", "link": "http://3.12.84.76:3031/login", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        ...
        # dataSource = OrderedDict()
        # dataSource = []
        # dataSource.append({"id": "2", "x": "15", "y": "30", "name": "Login", "link":"http://3.12.84.76:3031/login", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "A. Login"})
        # dataSource.append({"id": "3", "x": "15", "y": "60", "name": "Set Password", "link":"http://3.12.84.76:3031/set-password", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "B. Set Password"})
        # dataSource.append({"id": "4", "x": "15", "y": "90", "name": "Welcome", "link":"http://3.12.84.76:3031/welcome", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "C. Welcome"})
        # dataSource.append({"id": "5", "x": "45", "y": "45", "name": "User Profile", "link":"http://3.12.84.76:3031/app/me", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "D. User Profile"})
        # dataSource.append({"id": "6", "x": "45", "y": "75", "name": "AboutMe Survey", "link":"http://3.12.84.76:3031/app/about-me/start", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "E. AboutMe Surveey"})
        # dataSource.append({"id": "7", "x": "75", "y": "45", "name": "Setting",  "link":"http://3.12.84.76:3031/app/settings", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "F. Setting"})
        # dataSource.append({"id": "8", "x": "75", "y": "75", "name": "My Map",  "link":"http://3.12.84.76:3031/app/my-map", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "G. My Map"})
