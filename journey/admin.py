...
class JourneyAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        dataSource = []
        dataSource.append({"id": "2", "x": "90", "y": "480", "name": "1A. Invitation Email", "color": "#FFEEDD", "link": "", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "3", "x": "190", "y": "480", "name": "Invided Landing Page", "color": "#FFEEDD", "link": "http://3.15.16.117:3030", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "4", "x": "290", "y": "480", "name": "2A. Confirm Details(Account Created)", "color": "#FFEEDD", "link": "", "width": "80", "height": "40", "shape": "RECTANGLE", "tooltext": ""})
        ...
        dataSource.append({"id": "10", "x": "790", "y": "480", "name": "8. Dashboard", "color": "#6B6B6B", "link": "", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
