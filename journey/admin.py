...
class JourneyAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        dataSource = []
        dataSource.append({"id": "2", "x": "90", "y": "480", "name": "1A. Invitation Email", "link": "", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "3", "x": "190", "y": "480", "name": "Invided Landing Page", "link": "http://3.15.16.117:3030", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "4", "x": "290", "y": "480", "name": "2A. Confirm Details(Account Created)", "link": "", "width": "80", "height": "40", "shape": "RECTANGLE", "tooltext": ""})
        ...
        dataSource.append({"id": "10", "x": "790", "y": "480", "name": "8. Dashboard", "link": "", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "11", "x": "90", "y": "410", "name": "1B. Organic Search", "link": "", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "12", "x": "210", "y": "410", "name": "2B. Landing Page(Try it)/Capture Details/Sales", "link": "", "width": "100", "height": "50", "shape": "RECTANGLE", "tooltext": ""})
        ...
        dataSource.append({"id": "16", "x": "590", "y": "410", "name": "6A. KeyLines 'MyMap'", "link": "http://3.15.16.117:3031/app/my-map", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "17", "x": "690", "y": "410", "name": "7A. KeyLines 'ProjectMap'", "link": "", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "18", "x": "790", "y": "410", "name": "8A. DB1", "link": "", "width": "80", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        ...
        dataSource.append({"id": "28", "x": "640", "y": "270", "name": "6B. Search Stakeholder", "link": "", "width": "160", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
        dataSource.append({"id": "29", "x": "640", "y": "200", "name": "6C. Add New Stakeholder", "link": "", "width": "160", "height": "30", "shape": "RECTANGLE", "tooltext": ""})
