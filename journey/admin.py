...
class JourneyAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        # dataSource = OrderedDict()
        # dataSource = []
        # dataSource.append({"id": "2", "x": "15", "y": "30", "name": "Login", "link":"http://13.211.252.207:3031/login", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "A. Login"})
        # dataSource.append({"id": "3", "x": "15", "y": "60", "name": "Set Password", "link":"http://13.211.252.207:3031/set-password", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "B. Set Password"})
        # dataSource.append({"id": "4", "x": "15", "y": "90", "name": "Welcome", "link":"http://13.211.252.207:3031/welcome", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "C. Welcome"})
        # dataSource.append({"id": "5", "x": "45", "y": "45", "name": "User Profile", "link":"http://13.211.252.207:3031/app/me", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "D. User Profile"})
        # dataSource.append({"id": "6", "x": "45", "y": "75", "name": "AboutMe Survey", "link":"http://13.211.252.207:3031/app/about-me/start", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "E. AboutMe Surveey"})
        # dataSource.append({"id": "7", "x": "75", "y": "45", "name": "Setting",  "link":"http://13.211.252.207:3031/app/settings", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "F. Setting"})
        # dataSource.append({"id": "8", "x": "75", "y": "75", "name": "My Map",  "link":"http://13.211.252.207:3031/app/my-map", "width": "160", "height": "60", "shape": "RECTANGLE", "tooltext": "G. My Map"})
