    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mapType', models.CharField(blank=True, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('projectUser', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='shgroup.ProjectUser')),
        ...
        migrations.AddField(
            model_name='projectuser',
            name='team',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='team.Team'),
        ),
        migrations.AddField(
            model_name='projectuser',
            name='user',
        ...
        migrations.AddField(
            model_name='projectuser',
            name='userPermission',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='auth.Permission'),
        ),
    ]
